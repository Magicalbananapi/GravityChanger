...
public abstract class PersistentProjectileEntityMixin extends Entity {
    ...
    //TODO: Verify
    @ModifyArgs(
        method = "<init>(Lnet/minecraft/entity/EntityType;Lnet/minecraft/entity/LivingEntity;Lnet/minecraft/world/World;Lnet/minecraft/item/ItemStack;)V",
        at = @At(
            value = "INVOKE",
    ...
    private static void modifyargs_init_init_0(
        ...
        LivingEntity owner, World world, ItemStack itemStack
    ) {
